...
int test19_crl(void *arg)
{
        ...
        pid1 = start(cons_rdN,4000, 130, "cons_rd0",  0);
        pid2 = start(cons_rdN,4000, 132, "cons_rd0",  0);
        pid3 = start(cons_rdN,4000, 131, "cons_rd0",  0);
        pid4 = start(cons_rdN,4000, 129, "cons_rd0",  0);
        waitpid(pid2, 0);
        waitpid(pid3, 0);
        waitpid(pid1, 0);
        waitpid(pid4, 0);
